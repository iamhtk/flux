...
.flux-card h2 {
  font-size: 48px;
  font-weight: 700;
  background-image: linear-gradient(135deg, ${gradient.from}, ${gradient.to});
...
`.trim()
  ...
  const resetParams = () => {
    setA(3); setB(4); setDelta(Math.PI / 2); setSpeed(1); setStrokeWidth(2)
    setGradient(gradientPresets[0]); setText('Flux'); timeRef.current = 0
  }
  ...
  return (
    <div style={{
      ...
      flexDirection: 'column', padding: '24px', boxSizing: 'border-box', overflow: 'hidden'
    }}>
      ...
      <motion.div
        ...
        style={{
          ...
          alignItems: 'center', marginBottom: '24px', flexShrink: 0
        }}
      >
        <div>
          <h1 style={{
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
            onClick={randomize} className="glass"
            style={{
          ...
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
            ...
            style={{
              ...
              fontSize: '14px', boxShadow: '0 4px 16px rgba(0, 122, 255, 0.3)'
            }}>
      ...
      {/* Main Content */}
      <div style={{ width: '100%', flex: 1, display: 'flex', gap: '24px', minHeight: 0 }}>
        ...
        <motion.div
          ...
          className="glass-heavy preview-card"
          style={{
            flex: 1, borderRadius: 'var(--radius-lg)', padding: '32px',
            display: 'flex', flexDirection: 'column', alignItems: 'center',
            justifyContent: 'center', position: 'relative', overflow: 'hidden', minHeight: 0
          }}
        >
          {/* Subtle gradient tint backplate */}
          <div style={{
          ...
          {text && (
            <motion.h2
              ...
              /* Feed CSS vars so the title uses the active gradient */
              style={{
                fontSize: '56px',
                fontWeight: '700',
                marginTop: '20px',
                ['--title-from']: gradient.from,
                ['--title-to']: gradient.to
              }}
            >
              {text}
            </motion.h2>
        ...
        <motion.div
          ...
          className="glass"
          style={{
            width: '380px', borderRadius: 'var(--radius-lg)', padding: '24px',
            display: 'flex', flexDirection: 'column', gap: '20px',
            overflowY: 'auto', overflowX: 'hidden', flexShrink: 0
          }}
        >
          <h3 style={{ fontSize: '18px', fontWeight: '600', marginBottom: '0px' }}>
            Controls
          </h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
              {gradientPresets.map((preset, index) => (
                <motion.button
                  ...
                  onClick={() => setGradient(preset)} title={preset.name}
                  style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <input
                ...
                style={{ flex: 1, height: '40px', border: '1px solid var(--glass-border)',
          ...
          <div>
            ...
            <input type="range" min="1" max="10" step="1" value={a}
          ...
          <div>
            ...
            <input type="range" min="1" max="10" step="1" value={b}
          ...
          <div>
            ...
            <input type="range" min="0" max={Math.PI * 2} step="0.1" value={delta}
              onChange={(e) => setDelta(Number(e.target.value))} style={{ width: '100%' }} />
          </div>
          ...
          <div>
            ...
            <input
              ...
              style={{
                ...
                border: '1px solid var(--glass-border)', fontSize: '14px', fontWeight: '500',
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
            onClick={() => setIsAnimating(!isAnimating)} className="glass"
            style={{
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
            onClick={resetParams}
            style={{
              padding: '12px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--glass-border)',
              cursor: 'pointer', fontWeight: '600', fontSize: '14px', color: 'var(--text-secondary)',
